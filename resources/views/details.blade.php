                        ...
                        <div class="row g-4">
                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="details-image-vertical black-slide rounded">
                                            ...
                                            <div>
                                                <img src="{{asset('assets/images/fashion/product/front')}}/{{$image}}" class="img-fluid blur-up lazyload" alt="">
                                            </div>
                                            @endforeach
                                            @endif
                                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="cloth-details-size">
                                    ...
                                    {{ round(($product->regular_price - sale_price)/$product->regular_price)*100}}
                                    % off</span>
                                        @else
                                    ...
                                    <div class="product-buttons">
                                        <a href="{{route('BuyAndSellINQ.index')}}" class="btn btn-solid">
