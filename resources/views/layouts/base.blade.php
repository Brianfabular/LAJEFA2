...
<head>
    ...
    <link rel="apple-touch-icon" href="{{ asset('assets/images/img/Licons.png') }}">
    <link rel="icon" href="{{ asset('assets/images/img/Licons.png') }}" type="image/x-icon">
    <link rel="icon" href="{{ asset('assets/images/img/Licons.png') }}" type="image/x-icon">
    <meta name="theme-color" content="#e87316">
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="apple-mobile-web-app-status-bar-style" content="black">
    <meta name="apple-mobile-web-app-title" content="Surfside Media">
    <meta name="msapplication-TileImage" content="{{ asset('assets/images/img/Licons.png') }}">
                            ...
                            <div class="menu-left">
                                <div class="brand-logo">
                                    <a href="{{route('app.index')}}">
                                        <img src="{{asset('assets/images/img/lo.png')}}" class="h-logo img-fluid blur-up lazyload"
                                            alt="logo">
                                    </a>
                                </div>
                                ...
                                <ul>
                                    ...
                                    <li class="onhover-dropdown wislist-dropdown">
                                        <div class="cart-media">
                                            <a href="wishlist/list.html" style="color: white;">
                                    ...
                                    <li class="onhover-dropdown wislist-dropdown">
                                        <div class="cart-media">
                                            <a href="cart/list.html" style="color: white;">
                                    ...
                                    <li class="onhover-dropdown">
                                        ...
                                        <a class="d-block text-white">Services</a>
                                        </div>
                                            ...
                                            <ul>
                                                @if(Route::has('login'))
                                                    @auth
                                                        ...
                                                        @else
                                                            <li>
                                                                <a href="{{route('user.index')}}" class="d-block">My Accout</a>
                                                            </li>
                                                        @endif
                                                            <li>
                            ...
                            <div class="brand-logo" >
                                <a href="index.htm" class="footer-logo float-start" >
                                    <img src="{{ asset('assets/images/logo.png')}}" class="f-logo img-fluid blur-up lazyload"
                                        alt="logo" style="border-radius: 20px 0px 20px 0px;">
                                </a>
                            </div>
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"><p>032-407-6687</p><p>0917-117-4119</p></span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light"> <p></p>Cebu Area

Tan Kim Building, 80 Tres Borces Padres St, Cebu City, 6000 Cebu

Sitio Lupa, Mandaue City, 6014 Cebu</span></span>
                                </li>
                                <li>
                        ...
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="{{route('AboutUs.index')}}" class="font-dark">About Us</a>
                                    </li>
                                    <li>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="{{route('shop.index')}}" class="font-dark">Buy and Sell</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Industrial and heavy-agri equipment</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Chemical Distributor</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Hazardous Waste Category</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Waste Management</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="sub-footer bg-dark">
            <div class="container">
                <div class="row gy-3">
                    <div class="col-md-6">
                        <ul>
                            <li class="font-light">Connect with us:</li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/img/fb.png')}}" class="img-fluid blur-up lazyload"
                                        alt="FB icon">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0)">
                                    <img src="{{asset('assets/images/img/gmail.png')}}" class="img-fluid blur-up lazyload"
                                        alt="payment icon">
                                </a>
                            </li>
                    ...
                    <div class="col-md-6 ">
                        <p class="mb-0 font-light"> All Right Reserved by &copy; LajefaTrading 2022</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-content ">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-title">
                        <h2 class="tt-title">Inquire Now!</h2>
