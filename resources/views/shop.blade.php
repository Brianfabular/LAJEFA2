                                        ...
                                        <ul class="category-list">
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">Industria and Heavy Equipment</label>
                                                    <p class="font-light"></p>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">Chemical and Distributor</label>
                                                    <p class="font-light"></p>
                                                </div>
                                            </li>
                                            ...
                                            <li>
                                                <div class="form-check ps-0 custome-form-check">
                                                    ...
                                                    <label class="form-check-label">Hazardous Waste Categories</label>
                                                    <p class="font-light">(5)</p>
                                                </div>
                                            </li>
                            ...
                            <div class="product-box">
                                ...
                                <div class="product-details">
                                    ...
                                    <div class="main-price">
                                        ...
                                        <h3 class="theme-color">P{{$product->regular_price}}</h3>
